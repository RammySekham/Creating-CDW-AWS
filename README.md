...
#
### Project:
##### For a streaming music app company sparpkify, an ETL pipeline is built , that extracts raw data in form of json logs from S3 bucket, staged in Redshift, and transformed  into a set of dimensional tables(database) for the analytics team.
#
#### Process:
